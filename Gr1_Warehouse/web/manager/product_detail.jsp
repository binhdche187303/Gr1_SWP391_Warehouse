                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add" action="productdetail" method="post">
                            ...
                            <div class="mb-3">
                                <label for="sku" class="form-label">Mã Sku</label>
                                <input type="text" class="form-control" id="sku" name="sku" required value="${sessionScope.sku}">
                            </div>
                            <div class="mb-3">
                                <label for="price" class="form-label">Giá</label>
                                <input type="number" class="form-control" id="price" name="price" required min="1" value="${sessionScope.price}">
                            </div>
                            <!-- Thương hiệu với mũi tên dropdown -->
                            <div class="mb-3">
                                <label for="size" class="form-label">Phân loại</label>
                                    ...
                                    <select class="form-select" id="size" name="size" >
                                        <c:forEach var="ls" items="${requestScope.listSizes}">
                                            ...
                                            <c:if test="${not sizeExists}">
                                                <option value="${ls.size_id}" ${sessionScope.size eq ls.size_id ? 'selected' : ''} >${ls.size_name}</option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                                </div>
...
//Fix Add new variant
            ...
            <c:if test="${not empty sessionScope.errorMessage}">
                var addPriceModal = document.getElementById('addprice');
                var modal = new bootstrap.Modal(addPriceModal);
                modal.show();
