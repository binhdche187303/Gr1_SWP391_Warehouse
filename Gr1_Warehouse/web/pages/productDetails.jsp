                ...
                <div class="row">
                                                            ...
                                                            <div class="right-box-contain">
                                                                ...
                                                                <div class="price-rating">
                                                                    <h3 class="theme-color price">
                                                                        <span id="current-price">${product.variants[0].price}</span>đ
                                                                    </h3>
                                                                </div>
                    ...
                    <script>
                        function updatePrice(element) {
                            // Xóa class active của tất cả các kích thước
                    ...
                    <div class="note-box product-packege">
                        ...
                        <input type="hidden" id="selected-variant-id" name="variant_id" value="${product.variants[0].variantId}" />
                    ...
                    <div class="paymnet-option">
                        ...
                        <ul>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="${pageContext.request.contextPath}/assets/images/product/payment/1.svg"
                                         class="blur-up lazyload" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="${pageContext.request.contextPath}/assets/images/product/payment/2.svg"
                                         class="blur-up lazyload" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="${pageContext.request.contextPath}/assets/images/product/payment/3.svg"
                                         class="blur-up lazyload" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="${pageContext.request.contextPath}/assets/images/product/payment/4.svg"
                                         class="blur-up lazyload" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="${pageContext.request.contextPath}/assets/images/product/payment/5.svg"
                                         class="blur-up lazyload" alt="">
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-pane fade show active" id="description" role="tabpanel"
                            ...
                            <div class="product-description">
                                ...
                                <div class="banner-contain nav-desh">
                                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/banner/14.jpg"
                                            ...
                                            <ul class="review-list">
                                                    ...
                                                    <div class="people-box">
                                                        <div>
                                                            <div class="people-image">
                                                                <img src="${pageContext.request.contextPath}/assets/images/review/1.jpg"
                                                ...
                                                <li>
                                                    <div class="people-box">
                                                        <div>
                                                            <div class="people-image">
                                                                <img src="${pageContext.request.contextPath}/assets/images/review/2.jpg"
                                                                     class="img-fluid blur-up lazyload"
                                                                     alt="">
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="people-box">
                                                        <div>
                                                            <div class="people-image">
                                                                <img src="${pageContext.request.contextPath}/assets/images/review/3.jpg"
                                                                     class="img-fluid blur-up lazyload"
                                                                     alt="">
                                                            </div>
                                                        </div>
        ...
        <div class="right-sidebar-box">
            <div class="vendor-box">
                <div class="verndor-contain">
                    <div class="vendor-image">
                        <img src="${pageContext.request.contextPath}/assets/images/product/vendor.png" class="blur-up lazyload" alt="">
                    </div>
                ...
                <div class="category-menu">
                    ...
                    <ul class="product-list product-right-sidebar border-0 p-0">
                        <li>
                            <div class="offer-product">
                                <a href="product-left-thumbnail.html" class="offer-image">
                                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/product/23.png"
                        ...
                        <li>
                            <div class="offer-product">
                                <a href="product-left-thumbnail.html" class="offer-image">
                                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/product/24.png"
                                         class="blur-up lazyload" alt="">
                                </a>
                        ...
                        <li>
                            <div class="offer-product">
                                <a href="product-left-thumbnail.html" class="offer-image">
                                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/product/25.png"
                                         class="blur-up lazyload" alt="">
                                </a>
                        ...
                        <li class="mb-0">
                            <div class="offer-product">
                                <a href="product-left-thumbnail.html" class="offer-image">
                                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/product/26.png"
                                         class="blur-up lazyload" alt="">
                                </a>
            ...
            <div class="ratio_156 pt-25">
                <div class="home-contain">
                    <img src="${pageContext.request.contextPath}/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                         alt="">
                            ...
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left.htm">
                                        <img src="${pageContext.request.contextPath}/assets/images/cake/product/11.png"
                                             class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="${pageContext.request.contextPath}/assets/images/cake/product/7.png" class="img-fluid" alt="">
                                    </a>
                    ...
                    <div class="selection-section">
                        <div class="form-group mb-0">
                            <select id="input-state" class="form-control form-select">
                                <option selected disabled>Choose Weight${pageContext.request.contextPath}.</option>
...
<script>
//          function updateSizeId(element) {
//    // Xóa class active ở tất cả các lựa chọn
//    document.querySelectorAll('.select-packege a').forEach(a => a.classList.remove('active'));
//
//    // Đánh dấu lựa chọn hiện tại
//    element.classList.add('active');
//
//    // Lấy size_id từ data-size-id và cập nhật input ẩn
//    let sizeId = element.getAttribute('data-size-id');
