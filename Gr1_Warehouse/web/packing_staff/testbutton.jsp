                    ...
                    <div class="container mt-4">
                        <div class="card shadow-sm p-4">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr class="order-row" data-assigned="false">
                                        <td class="text-center">DH001</td>
                                        <td class="text-center">Chờ xử lý</td>
                                    ...
                                    <tr class="order-row" data-assigned="true">
                                        <td class="text-center">DH002</td>
                                        <td class="text-center">Đang giao hàng</td>
                                        <td class="text-center">Đã thanh toán</td>
                                        <td class="text-center">Nguyễn Văn A</td>
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-secondary" disabled>Đã xác nhận</button>
                                        </td>
                                        <td class="text-center">
                                            <a href="#">Xem chi tiết</a>
                                        </td>
                                    ...
                                    <tr class="order-row" data-assigned="true">
                                        <td class="text-center">DH004</td>
                                        <td class="text-center">Hoàn thành</td>
                                        <td class="text-center">Đã thanh toán</td>
                                        <td class="text-center">Trần Thị B</td>
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-secondary" disabled>Đã xác nhận</button>
                                        </td>
                                        <td class="text-center">
