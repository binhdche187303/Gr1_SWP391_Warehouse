...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <c:if test="${empty myShippingOrders}">
                        ...
                        <div class="card shadow-sm p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="ship-orders" class="btn btn-primary">Quay lại</a>
                                </div>
                            </div>
                            ...
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <tbody class="text-center">
                                    <c:forEach var="order" items="${myShippingOrders}">
                                        <tr class="order-row" data-status="${order.status}">
                                            <td>${order.order_id}</td>
                                            <td>${order.status}</td>
                                            <td>${order.payment_status}</td>
                                            <td>
                                                <a href="orderShippingDetail?orderId=${order.order_id}">
        ...
        <script>
            document.getElementById("filterButton").addEventListener("click", function () {
                ...
                if (isFiltered) {
                    ...
                    filterButton.textContent = "Lọc đơn đang giao hàng";
                } else {
                    orderRows.forEach(row => {
            ...
            $(document).ready(function () {
                $('#myTable').DataTable({
                    ...
                    "pageLength": 10, // Mặc định hiển thị 10 hàng mỗi trang
                    "searching": false, // Ẩn ô tìm kiếm
                    "lengthChange": false, // Ẩn tùy chọn số hàng trên mỗi trang (lengthMenu)
