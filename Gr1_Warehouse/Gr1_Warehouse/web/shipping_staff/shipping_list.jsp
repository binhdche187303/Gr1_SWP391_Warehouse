                    ...
                    <div class="container mt-4">
                        <div class="card shadow-sm p-4">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <a href="my-shipping-orders" class="btn btn-primary">Đơn hàng của tôi</a>
                            </div><br>
                            <!-- Your table content -->
                            <table class="table table-striped table-bordered">
                                <thead class="table-light">
                                    <tr class="small fw-light">
                                        ...
                                        <th class="small text-center" style="font-size: 12px;">Nhân viên vận chuyển</th>
                                ...
                                <tbody class="text-center">
                                    <c:choose>
                                                ...
                                                <tr class="small text-center order-row" data-assigned="${order.assigned_staff ne null}">
                                                    ...
                                                    <td class="text-center">
                                                        <c:if test="${empty order.assigned_staff}">
                                                            <form action="assignShippingOrder" method="post" class="d-flex justify-content-center">
                                                                <input type="hidden" name="orderId" value="${order.order_id}">
                                                                <button type="submit" class="btn btn-success btn-sm">Nhận đơn vận chuyển</button>
                                                            </form>
                                                        </c:if>
                                                    </td>
                                        ...
                                        <c:otherwise>
                                            <tr class="small">
                                                <td colspan="6" class="text-center">Không có đơn hàng nào cần vận chuyển.</td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
                                </tbody>
