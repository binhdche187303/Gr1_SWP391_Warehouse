...
public class RoleFilter implements Filter {
    ...
    static {
        ...
        rolePermissions.put(5, Arrays.asList("/my-packing-orders", "/orderPackingDetail", "/exportInvoice", "/packing-orders", "/confirmPackingServlet", "/assignPackingOrder", "/logout", "/error"));
        rolePermissions.put(7, Arrays.asList("/sale-orders", "/my-sale-orders", "/browse-cus", "/orderSaleDetail", "/assignSaleOrder", "/confirmSale", "/getOrderNote", "/logout", "/error"));
        rolePermissions.put(6, Arrays.asList("/ship-orders", "/my-shipping-orders", "/orderShippingDetail", "/assignShippingOrder", "/confirmShippingServlet", "/logout", "/error"));
    }
