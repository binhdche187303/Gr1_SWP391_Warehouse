...
<html lang="en" dir="ltr">
    ...
    <body>
        <%@ include file="/shipping_staff/shipping_dashboard.jsp" %>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc muốn xác nhận đã giao hàng thành công <strong id="confirmOrderId"></strong> không?
                                            </div>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <h5 class="fw-bold">Thông tin nhân viên vận chuyển</h5><br>
                                        <c:choose>
                                            <c:when test="${not empty orderDetail.staff_name}">
                                                ...
                                                <ul class="list-unstyled text-muted">
                                                    ...
                                                    <li>• Trạng thái đóng gói: ${orderDetail.shipping_status}</li>
                                                    <li>• Ngày nhận đơn: ${orderDetail.shipped_at}</li>
                                                </ul>
                                            </c:when>
                                            <c:otherwise>
                                                <p class="text-muted">Không có thông tin nhân viên vận chuyển.</p>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                confirmBtn.addEventListener('click', function () {
                    ...
                    if (orderStatus === "Đã giao hàng thành công") {
                        alert("Đơn hàng đã giao thành công, không thể xác nhận lại!");
                        return;
                    }
                ...
                confirmSubmitBtn.addEventListener('click', function () {
                    ...
                    fetch("/Gr1_Warehouse/confirmShippingServlet", {
                        method: 'POST',
                        headers: {
