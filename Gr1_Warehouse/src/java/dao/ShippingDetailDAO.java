...
public class ShippingDetailDAO extends DBContext {
    ...
    public boolean confirmShippingAndPaying(int orderId) {
        ...
        try {
            ...
            try (PreparedStatement updateShippingStmt = connection.prepareStatement(updateShippingSql); 
                    PreparedStatement updateOrderStmt = connection.prepareStatement(updateOrderSql); 
                    PreparedStatement updatePaymentStmt = connection.prepareStatement(updatePaymentSql);
                    PreparedStatement updateOrderPaymentStmt = connection.prepareStatement(updateOrderPaymentSql);) {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> shippingOrders = sdd.getOrderDetailById(8);
