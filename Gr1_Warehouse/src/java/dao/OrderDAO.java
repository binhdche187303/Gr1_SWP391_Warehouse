...
public class OrderDAO extends DBContext {
    ...
    public boolean processCheckoutWithPayment(int userId, String customerName, String phoneNumber, String email,
        ...
        try {
            ...
            // Tạo đơn hàng
            String orderSQL = "INSERT INTO Orders (user_id, customer_name, phone_number, email, shipping_address, notes, total_amount) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            orderStmt.setBigDecimal(7, totalAmount);
            ...
            String stockUpdateSQL = "UPDATE ProductVariants SET stock = stock - ? WHERE product_id = ? AND size_id = ?";
            stockStmt = conn.prepareStatement(stockUpdateSQL);
            ...
            for (OrderDetail detail : orderDetails) {
                ...
                stockStmt.setInt(3, detail.getSizeId());
                stockStmt.addBatch();
            }
