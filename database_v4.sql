...
--Trung
--Bánh quy AFC
(N'[1 THÙNG] Bánh quy giòn AFC vị rau', 4, 'B00048', N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị Caramel Flan', 4, 'B00049',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị cốm non', 4, 'B00050',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị lúa mì', 4, 'B00051',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị tảo biển', 4, 'B00052',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị bò bít tết', 4, 'B00053',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
(N'[1 THÙNG] Bánh quy giòn AFC vị chân gà xả tắc', 4, 'B00054',  N'Việt Nam', 4, N'Bánh quy giòn AFC không chỉ có hương vị thơm ngon mà còn phù hợp với chế độ ăn uống cân bằng và khỏe mạnh'),
--Bánh quy Cosy
(N'[1 THÙNG] Bánh quy Cosy Hạt bơ và điều', 4, 'B00055',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
(N'[1 THÙNG] Bánh quy Cosy Mè', 4, 'B00056',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
(N'[1 THÙNG] Bánh quy Cosy Marie', 4, 'B00057',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
(N'[1 THÙNG] Bánh quy Cosy nhân mứt hương táo', 4, 'B00058',  N'Việt Nam', 4, N'Bánh quy Cosy nhân mứt táo được chọn lọc từ những nguyên liệu chất lượng, tươi mới mang đến cho người tiêu dùng những chiếc bánh quy thơm ngon, độc đáo với nhân mứt táo mới lại cho bạn một ngày dài năng động.'),
(N'[1 THÙNG] Bánh quy hạt chocolate yến mạch Cosy Original', 4, 'B00059',  N'Việt Nam', 4, N'Bánh quy hạt socola yến mạch Cosy Original là sự kết hợp giữa hai nguyên liệu thơm ngon là yến mạch và socola. Bánh có hình dạng tròn, kích thước nhỏ nhắn, vừa ăn. Vỏ bánh màu nâu vàng, giòn rụm, thơm ngon, khi ăn mang đến vị ngọt ngào, đậm đà, hòa quyện với vị socola thơm béo và yến mạch bùi bùi.'),
(N'[1 THÙNG] Bánh quế Cosy Chocolate', 4, 'B00060',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
(N'[1 THÙNG] Bánh quế Cosy Dâu', 4, 'B00061',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
(N'[1 THÙNG] Bánh quế Cosy Xoài xí muội', 4, 'B00062',  N'Việt Nam', 4, N'Sản phẩm này được làm từ các thành phần như: bột mì, dầu cọ, muối, đường, canxi, natri, carbohydrate,… có tác dụng làm dịu cơn đói nhanh chóng và bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể.'),
--Bánh Solite
(N'[1 THÙNG] Bánh Solite Kinh Đô - vị bơ sữa', 4, 'B00063',  N'Việt Nam', 5, N'Bánh bông lan Solite được làm từ các thành phần tự nhiên như trứng gà, bột mì, đường, dầu nành, dầu cọ,… nên hương vị phù hợp với đa dạng khẩu vị của người dùng.'),
(N'[1 THÙNG] Bánh Solite Kinh Đô - vị lá dứa', 4, 'B00064',  N'Việt Nam',  5, N'Bánh bông lan Solite được làm từ các thành phần tự nhiên như trứng gà, bột mì, đường, dầu nành, dầu cọ,… nên hương vị phù hợp với đa dạng khẩu vị của người dùng.'),
(N'[1 THÙNG] Bánh Solite Kinh Đô - vị dâu', 4, 'B00065',  N'Việt Nam',  5,  N'Bánh bông lan Solite được làm từ các thành phần tự nhiên như trứng gà, bột mì, đường, dầu nành, dầu cọ,… nên hương vị phù hợp với đa dạng khẩu vị của người dùng.'),
(N'[1 THÙNG] Bánh Solite Kinh Đô - vị socola', 4, 'B00066',  N'Việt Nam',  5, N'Bánh bông lan Solite được làm từ các thành phần tự nhiên như trứng gà, bột mì, đường, dầu nành, dầu cọ,… nên hương vị phù hợp với đa dạng khẩu vị của người dùng.'),
--Snack khoai tây
(N'[1 THÙNG] Snack khoai tây Slide vị gà nướng', 4, 'S00021',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
(N'[1 THÙNG] Snack khoai tây Slide vị phô mai', 4, 'S00022',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
(N'[1 THÙNG] Snack khoai tây Slide vị kem hành', 4, 'S00023',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
(N'[1 THÙNG] Snack khoai tây Slide vị thịt nướng', 4, 'S00024',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
(N'[1 THÙNG] Snack khoai tây Slide vị thơm cay', 4, 'S00025',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
(N'[1 THÙNG] Snack khoai tây Slide vị tự nhiên', 4, 'S00026',  N'Việt Nam', 2, N'Snack khoai tây Slide được sản xuất theo quy trình khép kín, hiện đại để khoai tây vẫn giữ được những dưỡng chất như ban đầu.'),
--Bánh mì tươi
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Sừng bò', 4, 'B00067',  N'Việt Nam', 3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Bò sốt Bulgogi', 4, 'B00068',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Gà sốt chua cay', 4, 'B00069',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Pizza Xúc Xích', 4, 'B00070',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Chà Bông', 4, 'B00071',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Burger bò', 4, 'B00072',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Burger gà', 4, 'B00073',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Socola', 4, 'B00074',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Bơ sữa', 4, 'B00075',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Lá dứa', 4, 'B00076',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
(N'[1 THÙNG] Bánh mì tươi Kinh Đô - Bơ đậu phộng', 4, 'B00077',  N'Việt Nam',  3, N'Những chiếc bánh mì tươi Kinh Đô vừa thơm ngon vừa có đầy đủ vị ngọt và mặn.'),
--Bánh Oreo
(N'[1 THÙNG] Bánh quy Oreo - Việt Quất', 4, 'B00078',  N'Việt Nam', 4, N'Bánh Oreo có hương vị thơm ngon, giòn, béo và ngọt dịu với đa dạng nhân kem như: socola, dâu, vani,…'),
(N'[1 THÙNG] Bánh quy Oreo - Dâu', 4, 'B00079',  N'Việt Nam', 4, N'Bánh Oreo có hương vị thơm ngon, giòn, béo và ngọt dịu với đa dạng nhân kem như: socola, dâu, vani,…'),
(N'[1 THÙNG] Bánh quy Oreo - Socola', 4, 'B00080',  N'Việt Nam',4, N'Bánh Oreo có hương vị thơm ngon, giòn, béo và ngọt dịu với đa dạng nhân kem như: socola, dâu, vani,…'),
(N'[1 THÙNG] Bánh quy Oreo - Vanilla', 4, 'B00081',  N'Việt Nam', 4, N'Bánh Oreo có hương vị thơm ngon, giòn, béo và ngọt dịu với đa dạng nhân kem như: socola, dâu, vani,…')
...
(20, N'assets/images/img_products/20_2.jpg'),
